...
<div class="row">
    ...
    <div class="col-sm-12">
        <form method="POST">
                ...
                <div class="callout callout-cpanel">
                    ...
                    <?php else: ?>
                        <b>
                            ...
                            <a href="https://plumtex.com/marketplace#modules">Get your license here.</a>
                        </b>
                    <?php endif; ?>
            ...
            <?php else: ?>
                <div class="callout callout-cpanel">Your key is invalid!</div>
            <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-xs-8">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="key">Place Your Plumtex White Label Key:</label>
    ...
    <?php /*
      ...
      <div class="checkbox">
      <label>
      <input type="checkbox" name="disable_marketplace" value="1" <?= (isset($branding['disable_marketplace']) AND $branding['disable_marketplace'] == 1) ? 'checked' : ''; ?>> Plumtex Marketplace
      </label>
      </div>
      </div>
      <div class="">
