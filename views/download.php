        ...
        <form method="POST">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <button name="download_cms" value="download_cms" class="btn btn-primary btn-xs">DOWNLOAD</button>
                    <button name="remove_current_version" value="remove_current_version" class="btn btn-danger btn-xs">
                ...
                <div class="col-md-4">
                    <h2>Artavolo cPanel Plugin version</h2>
