...
<form method="POST">
    ...
    <?php if (isset($all_domains) and $all_domains) { ?>
        <div id="row-no-matches" class="callout callout-silver">
            <strong>Select domain:</strong><br /><br />

            <select name="domain" class="form-control inline-element">
    ...
    <?php } else { ?>
        <div class="alert alert-warning" role="alert">
            <div class="row">
                <div class="col-sm-6">
                    <p style="margin: 8px 0 0 10px;">Seems you do not have any available domains</p>
                </div>
                <div class="col-sm-6" style="text-align: right;">
                    <a class="btn  btn-default" href="./addon/index.html">Create new domain</a>
                    &nbsp; or &nbsp;
                    <a class="btn btn-default" href="./subdomain/index.html">Create Sub-domain</a>
                </div>
            </div>
        </div>
    <?php } ?>
        ...
        <div class="row">
            <div class="form-group">
                <div class="col-lg-12" style="margin-bottom: 50px;">
                    <button class="btn btn-lg btn-primary" type="submit">Install Artavolo</button>
                </div>
            </div>
        </div>
    <?php } ?>
