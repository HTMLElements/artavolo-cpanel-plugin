...
file_put_contents(__DIR__ . '/log_pt_hooks.txt', json_encode($input));

include_once(__DIR__ . '/../lib/PlumtexHooks.php');

// Any switches passed to this script 
$switches = (count($argv) > 1) ? $argv : array();

$controller = new PlumtexHooks($input);
...
// Exit
echo '0 artavolo/pt_hooks.php needs a valid switch';
exit(1);
